...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sample == null){
            Log.e(TAG, "Cannot find sample " + mAnswerSampleID);
            return;
        }
    ...
    //  (6): Instantiate a SimpleExoPlayer object using DefaultTrackSelector and DefaultLoadControl.
        ...
        String userAgent = Util.getUserAgent(this, "QuizApp");
        MediaSource videoSource = new ExtractorMediaSource(uri, new DefaultDataSourceFactory(this, userAgent),
    ...
    //  (11): Override onDestroy() to stop and release the mPlayer when the Activity is destroyed.
