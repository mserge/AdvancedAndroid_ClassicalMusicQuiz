...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  (1): Create a method to initialize the MediaSession. It should create the MediaSessionCompat object,
        ...
        mMediaSession.setPlaybackState(mStateBuilder
                .build());
        //  (2): Create an inner class that extends MediaSessionCompat.Callbacks, and override the onPlay(), onPause(), and onSkipToPrevious() callbacks.
