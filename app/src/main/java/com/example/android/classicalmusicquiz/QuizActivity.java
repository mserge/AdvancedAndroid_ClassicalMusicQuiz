...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    public void showNotification(PlaybackStateCompat state){
        ...
        if(state.getState() == PlaybackStateCompat.STATE_PLAYING){
            ...
            icon_string = getString(R.string.exo_controls_pause_description);
        }else {
            icon = R.drawable.exo_controls_play;
            icon_string = getString(R.string.exo_controls_play_description);
        }
        NotificationCompat.Action play_pause_action = new NotificationCompat.Action(icon, icon_string,
                MediaButtonReceiver.buildMediaButtonPendingIntent(this,
                        PlaybackStateCompat.ACTION_PLAY_PAUSE));

        NotificationCompat.Action restart_action = new NotificationCompat.Action(R.drawable.exo_controls_rewind, getString(R.string.exo_controls_rewind_description),
                MediaButtonReceiver.buildMediaButtonPendingIntent(this,
